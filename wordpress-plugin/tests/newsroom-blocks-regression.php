...
function wwh_rest_author_profile(array $user): array { $id = (int) ($user['id'] ?? 0); return ['role' => (string) get_user_meta($id, '_ww_author_role', true), 'profilePhoto' => [], 'socials' => []]; }
...
function byline_sports_game_ids_for_season($season, $team = '', $published = true): array { return []; }
...
function parse_blocks($content): array { return $content === 'manual' ? [['blockName' => 'byline/game-score', 'attrs' => ['source' => 'manual', 'gameId' => 202], 'innerBlocks' => []]] : [['blockName' => 'byline/game-score', 'attrs' => ['source' => 'primary'], 'innerBlocks' => []]]; }
...
function wwh_format_school_event(WP_Post $post): array { $start = wwh_meta_value($post->ID, '_ww_event_start_datetime'); return ['id' => $post->ID, 'title' => $post->post_title, 'eventType' => wwh_meta_value($post->ID, '_ww_event_type'), 'startDate' => $start, 'endDate' => '', 'location' => wwh_meta_value($post->ID, '_ww_event_location'), 'description' => '', 'externalUrl' => '', 'display' => ['date' => $start, 'time' => '7:00 PM', 'status' => 'Scheduled']]; }
...
$newsroom_test['posts'] = [
    new WP_Post(['ID' => 101, 'post_type' => 'post', 'post_status' => 'publish', 'post_author' => 11, 'post_name' => 'first-story', 'post_title' => 'First Story', 'post_content' => '', 'post_date' => '2026-08-20 12:00:00', 'post_date_gmt' => '2026-08-20 16:00:00']),
...
$newsroom_test['meta'][201] = ['_ww_start_datetime' => '2026-08-20T19:00', '_ww_game_status' => 'final', '_ww_wildcats_score' => '3', '_ww_opponent_score' => '1', '_ww_opponent' => 'Rivals', '_ww_sport_key' => 'varsity'];
$newsroom_test['meta'][202] = ['_ww_start_datetime' => '2099-09-20T19:00', '_ww_game_status' => 'upcoming', '_ww_opponent' => 'Future Academy', '_ww_sport_key' => 'varsity'];
...
$newsroom_test['posts'][0]->post_content = '';
