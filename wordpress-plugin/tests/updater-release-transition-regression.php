...
final class BylineTransitionApi
{
    ...
    public function chooseReference($branch)
    {
        return (object) [
            ...
            'downloadUrl' => 'https://github.com/weeklywildcat/byline/releases/download/v0.2.4/weekly-wildcat-headless.zip',
        ];
    }
...
function verify_transition($remote_source, $expected_error)
{
    ...
    if ($api->requestedPath !== 'weekly-wildcat-headless.php'
        || $api->requestedRef !== 'v0.2.4'
        || $info === null
        || $info->version !== '0.2.4'
        || $info->download_url !== 'https://github.com/weeklywildcat/byline/releases/download/v0.2.4/weekly-wildcat-headless.zip'
        ...
        fwrite(STDERR, "The installed 0.2.3 to canonical 0.2.4 updater transition failed.\n");
        exit(1);
    }
}
...
echo "Byline 0.2.3 to 0.2.4 release-asset transition regression passed.\n";
